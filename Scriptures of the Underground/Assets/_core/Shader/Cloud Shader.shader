	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord8 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 localWorldVar9 = float4( texCoord8, 0.0 , 0.0 );
				(localWorldVar9).xyz = GetCameraRelativePositionWS((localWorldVar9).xyz);
				float4 transform9 = mul(GetWorldToObjectMatrix(),localWorldVar9);
				float simplePerlin2D7 = snoise( transform9.xy );
				simplePerlin2D7 = simplePerlin2D7*0.5 + 0.5;
				float3 temp_cast_2 = (simplePerlin2D7).xxx;
				
				surfaceDescription.Color = temp_cast_2;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord8 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 localWorldVar9 = float4( texCoord8, 0.0 , 0.0 );
				(localWorldVar9).xyz = GetCameraRelativePositionWS((localWorldVar9).xyz);
				float4 transform9 = mul(GetWorldToObjectMatrix(),localWorldVar9);
				float simplePerlin2D7 = snoise( transform9.xy );
...
/*ASEBEGIN
Version=18500
1010;72.66667;871;958;1496.945;1089.493;1.399775;True;False
Node;AmplifyShaderEditor.NoiseGeneratorNode;7;-391.2796,-428.8046;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldToObjectTransfNode;9;-802.4475,-402.2035;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;8;-1026.411,-400.8036;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
